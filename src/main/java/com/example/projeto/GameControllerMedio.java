...
public class GameControllerMedio {
    @FXML
    ...
    private final int numMaxLetras = 6;
            ...
            if(palavraExistente(palavraJogador)){
                ...
                if (palavraJogador.equalsIgnoreCase(palavraCorreta)) {
                    if (idioma.equals("portugues")) {
                        ...
                        int pontosJogador = (numMaxTentativas - numTentativas) * 4;
                        ...
                        try {
                            ...
                            pagFinalController.getDificuldade("medio");
