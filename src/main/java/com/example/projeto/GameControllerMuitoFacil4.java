...
public class GameControllerMuitoFacil4 {
    @FXML
    ...
    private final int numMaxLetras = 4;
            ...
            if(palavraExistente(palavraJogador)){
                ...
                if (palavraJogador.equalsIgnoreCase(palavraCorreta)) {
                    if (idioma.equals("portugues")) {
                        ...
                        int pontosJogador = (numMaxTentativas - numTentativas) * 2;
                        ...
                        try {
                            ...
                            pagFinalController.getDificuldade("muitoFacil4");
