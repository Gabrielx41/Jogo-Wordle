...
public class GameControllerMuitoFacil3 {
    @FXML
    ...
    private final int numMaxLetras = 3;
            ...
            if(palavraExistente(palavraJogador)){
                ...
                if (palavraJogador.equalsIgnoreCase(palavraCorreta)) {
                    if (idioma.equals("portugues")) {
                        ...
                        int pontosJogador = (numMaxTentativas - numTentativas);
                        ...
                        try {
                            ...
                            pagFinalController.getDificuldade("muitoFacil3");
