...
public class GameControllerFacil {
    @FXML
    ...
    private final int numMaxLetras = 5;
            ...
            if(palavraExistente(palavraJogador)){
                ...
                if (palavraJogador.equalsIgnoreCase(palavraCorreta)) {
                    if (idioma.equals("portugues")) {
                        ...
                        int pontosJogador = (numMaxTentativas - numTentativas) * 3;
                        ...
                        try {
                            ...
                            pagFinalController.getDificuldade("facil");
